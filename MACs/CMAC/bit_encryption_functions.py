...
def xor(a,b,c= None , d = None):
    ...
    if d :
        ...
        while i < (len(a) and len(b)):
            ...
            i += 1
    return binary_to_hex(xor_string)
...
def hex_to_string(hex):
    ...
    while b < len(string_bytes):
        ...
        b +=1
    return str_value
def hex_padding_right(hex,length):
    binary  = hex_to_binary(hex)
    bin_length = int(length) * 4 
    ...
    for i in range(factor):
        ...
        if factor == 1:
            ...
            if temp[0] == '1':
                ...
                return binary_to_hex(xor(value,temp))
            else:
                return binary_to_hex(xor(shifted_value,temp))
        elif factor > 1:
